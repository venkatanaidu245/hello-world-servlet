...
// for display purposes
      ...
      git 'https://github.com/venkatanaidu245/hello-world-servlet.git'
...
post {
        success {
            mail to:"rayankulavenkatanaidu@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"rayankulavekatanaidu@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
